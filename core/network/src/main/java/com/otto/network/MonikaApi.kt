package com.otto.network

import com.otto.network.common.ApiResult
import com.otto.network.model.collect.request.CollectListRequest
import com.otto.network.model.collect.request.CollectRequest
import com.otto.network.model.collect.response.CollectListResponse
import com.otto.network.model.comment.request.CommentCreateRequest
import com.otto.network.model.comment.request.CommentListRequest
import com.otto.network.model.comment.request.CommentRemoveRequest
import com.otto.network.model.comment.request.CommentReplyRequest
import com.otto.network.model.comment.request.CommentSubListRequest
import com.otto.network.model.comment.request.CommentToggleLikeRequest
import com.otto.network.model.comment.response.CommentItem
import com.otto.network.model.comment.response.CommentListResponse
...
import com.otto.network.model.home.MonikaSubscribeData
...
import com.otto.network.model.pay.request.CheckPayStatusRequest
import com.otto.network.model.pay.request.CreateOrderRequest
import com.otto.network.model.pay.request.TestCreateOrderRequest
import com.otto.network.model.pay.response.CheckPayStatusResponse
import com.otto.network.model.pay.response.CreateOrderResponse
import com.otto.network.model.pay.response.TestCreateOrderResponse
import com.otto.network.model.post.request.PostDetailRequest
...
import com.otto.network.model.post.response.TagListResponse
import com.otto.network.model.subscribe.request.MyCreatorListRequest
import com.otto.network.model.subscribe.request.SubscribePlanListRequest
import com.otto.network.model.subscribe.request.SubscribeUserListRequest
import com.otto.network.model.subscribe.response.MyCreatorListResponse
import com.otto.network.model.subscribe.response.SubscribePlanCreateResponse
import com.otto.network.model.subscribe.response.SubscribePlanListResponse
...
import com.otto.network.model.user.request.UserProfileRequest
import com.otto.network.model.user.response.MonikaUserInfoModel
import com.otto.network.model.user.response.UserIncomeResponse
import com.otto.network.network.host.HOST
